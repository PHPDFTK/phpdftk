...
Generated: 2026-07-08 02:08:23 UTC
PHP: 8.4.23
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 96.09s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 34.07s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.35s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 20.08s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.68s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.08s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.84s |
...
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 316ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 201ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 355ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 128ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 344ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 180ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 205ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 216ms |
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 214ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 426ms |
...
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 213ms |
...
| testAddHeadingEmitsLargerText | PdfTest | PASS | 199ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 205ms |
| testLongTextAutoPaginates | PdfTest | PASS | 193ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 202ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 209ms |
...
| testAddTableUsesExplicitColumnWidthsWhenProvided | TableTest | PASS | 9ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 205ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 201ms |
...
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 210ms |
...
| testSaveToFile | BookmarkEditorTest | PASS | 205ms |
...
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 211ms |
...
| testKeepPages | PageSlicerTest | PASS | 214ms |
...
| testSetTrimBox | PageTransformerTest | PASS | 200ms |
...
| testScaleTo | PageTransformerTest | PASS | 214ms |
...
| testEvenPages | PageTransformerTest | PASS | 218ms |
...
| testSaveToFile | PdfMergerTest | PASS | 200ms |
...
| testStampOnSpecificPages | PdfStamperTest | PASS | 205ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 204ms |
| testStampWithOpacity | PdfStamperTest | PASS | 202ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 257ms |
| testStampImagePng | PdfStamperTest | PASS | 216ms |
...
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 199ms |
...
| testRedactByText | TextRedactorTest | PASS | 227ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 316ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 20.08s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.68s
...
| testQpdfCorpus with data set "qpdf/c-object-streams.pdf" | Tier2CorpusTest | PASS | 14ms |
...
| testQpdfCorpus with data set "qpdf/qpdfjob-ctest2.pdf" | Tier2CorpusTest | PASS | 29ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 8.08s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.98s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.08s
...
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.98s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.84s
...
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 901ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 863ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 544ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 195ms |
