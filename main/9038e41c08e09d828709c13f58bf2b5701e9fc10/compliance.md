...
Generated: 2026-07-08 02:11:31 UTC
PHP: 8.4.23
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 94.96s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 34.44s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.34s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.35s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.15s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.01s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.68s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 34.44s
...
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 226ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 678ms |
...
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 217ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 389ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 209ms |
...
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 208ms |
...
| testSaveWritesFile | PdfTest | PASS | 206ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 213ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 214ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 207ms |
...
| testSetNamedDestinations | WriterTest | PASS | 212ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 258ms |
...
| testFillTextField | FormFillerTest | PASS | 201ms |
| testFillManyFields | FormFillerTest | PASS | 211ms |
| testCheckCheckbox | FormFillerTest | PASS | 200ms |
| testUncheckCheckbox | FormFillerTest | PASS | 202ms |
| testSelectChoiceField | FormFillerTest | PASS | 207ms |
...
| testCustomField | MetadataEditorTest | PASS | 217ms |
| testSaveToFile | MetadataEditorTest | PASS | 209ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 203ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 216ms |
...
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 207ms |
...
| testEvenPages | PageTransformerTest | PASS | 210ms |
...
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 206ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 202ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 198ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 208ms |
...
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 215ms |
...
| testRedactArea | TextRedactorTest | PASS | 204ms |
...
| testSaveToFile | TextRedactorTest | PASS | 209ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.4s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.15s
...
| testQpdfCorpus with data set "qpdf/qpdfjob-ctest2.pdf" | Tier2CorpusTest | PASS | 28ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.61s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.01s
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.68s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 965ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 928ms |
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 817ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 630ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 561ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 559ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 366ms |
