...
Generated: 2026-07-08 02:04:44 UTC
PHP: 8.4.23
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 92.25s
...
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.72s |
...
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 232ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 343ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 88ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 116ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 535ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 220ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 202ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 223ms |
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 212ms |
...
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 207ms |
...
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 212ms |
...
| testEncryptAes256 | PdfEncryptTest | PASS | 210ms |
| testDecrypt | PdfEncryptTest | PASS | 204ms |
...
| testStampWithOpacity | PdfStamperTest | PASS | 200ms |
...
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 207ms |
...
| testQpdfCorpus with data set "qpdf/remove-info-no-moddate.pdf" | Tier2CorpusTest | PASS | 26ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.31s |
...
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.28s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.72s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 969ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 933ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 939ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 885ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 681ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 820ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 616ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 563ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 200ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 200ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 215ms |
