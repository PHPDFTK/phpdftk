...
Generated: 2026-07-08 04:15:39 UTC
PHP: 8.4.23
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 93.55s
...
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 9.44s |
...
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 438ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 213ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 310ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 159ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 75ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 102ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 455ms |
...
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 197ms |
...
| testEncryptAes128 | PdfEncryptTest | PASS | 433ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 204ms |
...
| testQpdfCorpus with data set "qpdf/c-object-streams.pdf" | Tier2CorpusTest | PASS | 13ms |
...
| testQpdfCorpus with data set "qpdf/qpdfjob-ctest2.pdf" | Tier2CorpusTest | PASS | 27ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.96s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 9.44s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 948ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 917ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 898ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 1.53s |
